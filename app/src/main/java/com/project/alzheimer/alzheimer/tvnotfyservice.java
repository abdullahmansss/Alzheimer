...
public class tvnotfyservice extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        myTimer = new Timer();
        tvnotfyservice.MyTimerTask myTask = new tvnotfyservice.MyTimerTask();
       player=MediaPlayer.create(this,R.raw.telev);
    ...
    class MyTimerTask extends TimerTask {
        public void run() {
           ...
           // player.start();
String mdctime;
            _mydatabase=new mydatabase(tvnotfyservice.this);
            ...
            if(cursor.moveToFirst()){
                ...
                {
                    tv_data[x]=new tvprogpropclass(cursor.getString(cursor.getColumnIndex("tvprogname")),
                            cursor.getString(cursor.getColumnIndex("tvprogtime")));
                    mdctime=cursor.getString(cursor.getColumnIndex("tvprogtime"));
